...
export class CapSonar extends SmartContract {
  ...
  @method p1_attack_p2(x: Field, y: Field) {
    const attack = Circuit.if(
      this.step.get().sub(this.P1_last_attack.get()).greaterThanOrEqual(5),
      Field(1),
      Field(0)
    );
    this.P1_last_attack.set(
      Circuit.if(
        attack.equals(Field(1)),
        this.step.get(),
        this.P1_last_attack.get()
      )
    );
    this.P2attackedatX.set(
      Circuit.if(attack.equals(Field(1)), x, this.P2attackedatX.get())
    );
    this.P2attackedatY.set(
      Circuit.if(attack.equals(Field(1)), y, this.P2attackedatY.get())
    );
    this.P2attacked.set(
      Circuit.if(attack.equals(Field(1)), Field(1), this.P2attacked.get())
    );
  }

  @method p2_attack_p1(x: Field, y: Field) {
    const attack = Circuit.if(
      this.step.get().sub(this.P2_last_attack.get()).greaterThanOrEqual(5),
      Field(1),
      Field(0)
    );
    this.P2_last_attack.set(
      Circuit.if(
        attack.equals(Field(1)),
        this.step.get(),
        this.P2_last_attack.get()
      )
    );
    this.P1attackedatX.set(
      Circuit.if(attack.equals(Field(1)), x, this.P1attackedatX.get())
    );
    this.P1attackedatY.set(
      Circuit.if(attack.equals(Field(1)), y, this.P1attackedatY.get())
    );
    this.P1attacked.set(
      Circuit.if(attack.equals(Field(1)), Field(1), this.P1attacked.get())
    );
  }
  ...
  @method p1_check_if_attacked(x: Field, y: Field, salt: Field) {
    ...
    const cond1 = x
      .equals(this.P1attackedatX.get())
      .and(y.equals(this.P1attackedatY.get()));
  ...
  @method p2_check_if_attacked(x: Field, y: Field, salt: Field) {
    ...
    const cond1 = x
      .equals(this.P2attackedatX.get())
      .and(y.equals(this.P2attackedatY.get()));
  ...
  @method p1_submerge(
    ...
    const submerge = Circuit.if(
      this.step.get().sub(this.P1_submerge_step.get()).greaterThanOrEqual(15),
      Field(1),
      Field(0)
    );
    this.P1_submerge_step.set(
      Circuit.if(
        submerge.equals(Field(1)),
        this.step.get(),
        this.P1_submerge_step.get()
      )
    );
    const dx = Circuit.if(
      submerge.equals(Field(1)),
  ...
  @method p2_submerge(
    ...
    const submerge = Circuit.if(
      this.step.get().sub(this.P2_submerge_step.get()).greaterThanOrEqual(15),
      Field(1),
      Field(0)
    );
    this.P2_submerge_step.set(
      Circuit.if(
        submerge.equals(Field(1)),
        this.step.get(),
        this.P2_submerge_step.get()
      )
    );
    const dx = Circuit.if(
      submerge.equals(Field(1)),
